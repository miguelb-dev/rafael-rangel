...
<body data-page-type="event-management">
    <div class="layout">
        ...
        <main>  
            <form class="form">
                <header class="form__header">
                    <h1 class="form__title">Crear evento</h1>
                ...
                <div class="form__inputs-container">
                    ...
                    <p class="event-type-indication">Tipo de evento</p>
                    <div class="event-type">
                        <div class="event-type__option">
                            <input id="important-day" type="radio" name="option" value="important-day" required>
                            <label for="important-day">Día de interés</label>
                        </div>
                        
                        <div class="event-type__option">
                            <input id="non-working-day" type="radio" name="option" value="non-working-day" required>
                            <label for="non-working-day">Día no laborable</label>
                        </div>
                    </div>

                    <label for="description">Descripción</label>
                    <textarea id="description" class="input__field" required></textarea>
                </div>
    ...
    <script src="../../../assets/js/events-management.js"></script>
</body>
</html>
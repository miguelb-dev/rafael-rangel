...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/event-view-styles.css">
...
<body>
    ...
    <!-- === HEADER SECTION === -->
        <header class="header">
            ...
            <nav class="header__nav">
                ...
                <!-- Menú de Navegación -->
                <ul class="nav__ul">
                    <li class="ul__item"><a class="ul__link" href="../../index.php">Inicio</a></li>
                    <li class="ul__item"><a class="ul__link" href="calendar.php">Calendario</a></li>
                    <li class="ul__item"><a class="ul__link" href="about-us.php"> Sobre Nosotros </a></li>
                    <li class="ul__item"><a class="ul__link" href="help.php">Ayuda</a></li>
                    <li class="ul__item ul__item--sign-in"><a class="ul__link" href="sign-in.php">Iniciar Sesión</a></li>
                </ul>
            </nav>
        </header>
        ...
        <!-- === MAIN SECTION === -->
        <main>
            <h1 class="main__title">*Tipo de día*</h1>
            <div class="event">
                <h2 class="event__title">*Título de la publicacion*</h2>
                <p class="event__date"><i class="fa-regular fa-calendar-days"></i>*fecha de la publicación*</p>
                
                <p class="event__description">*descripción de la publión*</p>
            </div>
        </main>
    ...
    <script src="../../assets/js/event-view.js"></script>
</body>
</html>
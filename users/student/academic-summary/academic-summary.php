...
<body data-page-type="academic-summary">
    <div class="layout">
        ...
        <header class="header">
            ...
            <nav class="header__nav">
                ...
                <ul class="nav__ul">
                    ...
                    <li class="ul__item"><a class="ul__link" href="academic-summary.php">Resumen Académico</a>
        ...
        <!-- === MAIN SECTION === -->
        <main>
            <h1 class="main__title">Resumen Académico</h1>

            <table id="academic-table" class="table">
                <thead>
                    <tr>
                        <th rowspan="2">Materia</th> <!-- Ocupa 2 filas -->
                        <th colspan="3">Calificaciones</th> <!-- Agrupa 3 columnas -->
                        <th colspan="3">Inasistencias</th> <!-- Agrupa 3 columnas -->
                    </tr>
                    <tr>
                        <!-- Subcabeceras de Calificaciones -->
                        <th>1er lapso</th>
                        <th>2do lapso</th>
                        <th>3er lapso</th>
                        <!-- Subcabeceras de Inasistencias -->
                        <th>1er lapso</th>
                        <th>2do lapso</th>
                        <th>3er lapso</th>
                    </tr>
                ...
                <tbody>
                    <?php include 'obtener-resumen-academico.php'; ?>
                </tbody>
